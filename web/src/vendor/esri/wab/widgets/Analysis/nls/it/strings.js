define(
   ({
    _widgetLabel: "Analisi",
    executeAnalysisTip: "Fare clic sullo strumento di analisi da eseguire",
    noToolTip: "Nessuno strumento di analisi selezionato.",
    back: "Indietro",
    next: "Avanti",
    home: "Home",
    ...
    cancelJob: "Annulla attività di analisi",
    paramName: "Nome parametro",
    link: "Collegamento",
