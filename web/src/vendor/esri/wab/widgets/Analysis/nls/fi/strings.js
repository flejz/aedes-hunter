define(
   ({
    _widgetLabel: "Analyysi",
    executeAnalysisTip: "Suorita napsauttamalla analyysityökalua",
    noToolTip: "Yhtään analyysityökalua ei ole valittu.",
    back: "Takaisin",
    next: "Seuraava",
    home: "Koti",
    jobSubmitted: "lähetty.",
    jobCancelled: "Peruutettu.",
    jobFailed: "Epäonnistui",
    jobSuccess: "Onnistui.",
    executing: "Suorittaa",
    cancelJob: "Peruuta analyysitehtävä",
    paramName: "Parametrin nimi",
    link: "Linkki",
