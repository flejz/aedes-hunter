define(
   ({
    _widgetLabel: "Phân tích",
    executeAnalysisTip: "Bấm vào công cụ phân tích để thực hiện",
    noToolTip: "Không có công cụ phân tích nào được chọn!",
    back: "Quay lại",
    next: "Tiếp",
    home: "Trang chủ",
    jobSubmitted: "đã đệ trình.",
    jobCancelled: "Đã hủy.",
    jobFailed: "Không thành công",
    jobSuccess: "Đã thành công.",
    executing: "Thực hiện",
    cancelJob: "Hủy tác vụ phân tích",
