define(
   ({
    _widgetLabel: "Analys",
    executeAnalysisTip: "Klicka på ett analysverktyg när du vill köra det",
    noToolTip: "Inget analysverktyg har valts.",
    back: "Tillbaka",
    next: "Nästa",
    home: "Hem",
    ...
    jobSuccess: "Klart.",
    executing: "Kör",
    cancelJob: "Avbryt analysen",
    paramName: "Parameternamn",
    link: "Länk",
